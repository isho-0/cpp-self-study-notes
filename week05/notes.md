...
| problem02 |  배열 입력 후 합계 출력하기   |   ✅   |
| problem03 |  배열 인덱스로 문자 출력하기   |   ✅   |
| problem04 |   조건에 따른 함수 호출하기   |   ✅   |
| problem05 |    LOT 함수 호출하기     |   ✅   |
| problem06 |   함수로 특수문자 출력하기    |   ✅   |
| problem07 |      배열 값 채우기      |   ✅   |
| problem08 |   전역 변수와 함수 호출하기   |   ✅   |
| problem09 |  배열 출력 함수 반복 호출하기  |   ✅   |
| problem10 |  배열 입력 후 역순 출력하기   |   ✅   |
| problem11 |   연속된 수 배열 출력하기    |   ✅   |
| problem12 |   배열 합으로 함수 호출하기   |   ✅   |
| problem13 |    배수 인덱스 출력하기     |   ✅   |

- 복습 문제

|  문제 번호   |          문제 이름          | 풀이 여부 |
|:--------:|:-----------------------:|:-----:|
| review01 |       괄호로 감싸 출력하기       |   ✅   |
| review02 |     조건에 따라 치킨집 출력하기     |   ✅   |
| review03 | 배열 두 개 입력값으로 초기화 후 출력하기 |   ✅   |
| review04 | 배열에 입력값 감소하며 저장 후 출력하기  |   ✅   |
| review05 |  문자 입력에 따른 배열 역순 출력하기   |   ✅   |
| review06 |   구간에 해당하는 배열 원소 출력하기   |   ✅   |
| review07 |   조건에 맞는 배열 채우기와 출력하기   |   ✅   |
| review08 |     배열 양쪽 채우기와 출력하기     |   ✅   |
| review09 |      배열 값 증가하며 채우기      |   ✅   |
| review10 |      배열 곱셈 패턴 채우기       |   ✅   |
| review11 |    배열 입력 후 나머지 값 채우기    |   ✅   |
| review12 |        배열 합 구하기         |   ✅   |
| review13 |       배열 n칸씩 출력하기       |   ✅   |
| review14 |    배열 인덱스 값 채우기 출력하기    |   ✅   |
